  ...
  return (
   ...
   <div className="flex flex-col items-center justify-center p-5 overflow-auto">
	<div className="flex space-x-5">
		<img alt="" className="w-12 h-12 rounded-full ri dark:bg-gray-500" src="https://source.unsplash.com/40x40/?portrait?1" />
		<img alt="" className="w-12 h-12 rounded-full ri dark:bg-gray-500" src="https://source.unsplash.com/40x40/?portrait?2" />
		<img alt="" className="w-12 h-12 rounded-full ri dark:bg-gray-500" src="https://source.unsplash.com/40x40/?portrait?3" />
		<img alt="" className="w-12 h-12 rounded-full ri dark:bg-gray-500" src="https://source.unsplash.com/40x40/?portrait?4" />
    <img alt="" className="w-12 h-12 rounded-full ri dark:bg-gray-500" src="https://source.unsplash.com/40x40/?portrait?1" />
		<img alt="" className="w-12 h-12 rounded-full ri dark:bg-gray-500" src="https://source.unsplash.com/40x40/?portrait?2" />
		<img alt="" className="w-12 h-12 rounded-full ri dark:bg-gray-500" src="https://source.unsplash.com/40x40/?portrait?3" />
		<img alt="" className="w-12 h-12 rounded-full ri dark:bg-gray-500" src="https://source.unsplash.com/40x40/?portrait?4" />
...
{/* <section className="py-6 ">
	<div className="container flex flex-col justify-center p-4 px-10">
...
<section className="py-6 sm:py-12 ">
	<div className="container p-6 mx-auto space-y-8">
		<div className="space-y-2 text-center dark:text-black">
			<h2 className="text-3xl font-bold">Partem reprimique an pro</h2>
			<p className="font-serif text-sm dark:text-gray-400">Qualisque erroribus usu at, duo te agam soluta mucius.</p>
		</div>
		<div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4 dark:text-white">
			<article className="flex flex-col dark:bg-gray-900">
				...
				<div className="flex flex-col flex-1 p-6">
					...
					<a rel="noopener noreferrer" href="#" className="text-xs uppercase tracki hover:underline dark:text-violet-400">Convenire</a>
